...
var (
	...
	pattern_Query_Tokens_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"hyperlane", "warp", "v1", "tokens"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Token_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"hyperlane", "warp", "v1", "tokens", "id"}, "", runtime.AssumeColonVerbOpt(false)))
)
