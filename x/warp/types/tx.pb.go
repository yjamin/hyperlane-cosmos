...
type MsgRemoteTransfer struct {
	...
	// Post Dispatch
	CustomHookId       string                `protobuf:"bytes,6,opt,name=custom_hook_id,json=customHookId,proto3" json:"custom_hook_id,omitempty"`
...
func (m *MsgRemoteTransfer) GetCustomHookId() string {
	if m != nil {
...
var fileDescriptor_9d1a3f4c9d53a091 = []byte{
	...
	,
}
